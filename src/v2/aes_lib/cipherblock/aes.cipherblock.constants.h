#ifndef AES_CIPHERBLOCK_CONSTANTS_H
...
#define MATRIX_LEN 4 // X & Y Length of matrices --> 4x4 Matrix resp. 16-Byte Matrices
#define KEY_LENGHT 16 // how many Bytes long the key has to be
#define N_ROUNDS 10 // Number of encryption-/decryption-rounds
...
#endif //AES_BLOCKCIPHER_CONSTANTS_LIB_H
